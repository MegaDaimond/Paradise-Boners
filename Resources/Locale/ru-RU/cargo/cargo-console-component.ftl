...
cargo-console-fund-withdraw-broadcast = [bold]{ $name } снял { $amount } евродолларов с { $name1 } \[{ $code1 }\]
cargo-console-fund-transfer-broadcast = [bold]{ $name } перевёл { $amount } евродолларов { $name1 } \[{ $code1 }\] на { $name2 } \[{ $code2 }\][/bold]
