...
delivery-spam-5 = БЕСССПЛАТНЫЙ ПОЛНЫЙ ДОСТУП!!
    ...
    .content =
        ...
        { "[bullet/]Примечание: Платежи, осуществляемые через отдел снабжения станции клиента, составляют примерно 5000 евродолларов за транзакцию, не считая индивидуальных сборов за обработку и НДС" }
...
delivery-spam-11 = Помоги маме и папе!
    ...
    .content =
        ...
        Это пишут твои родители: нам срочно нужны деньги! Правителство проверили наши налоги и теперь у нас долг в 100,000 евродолларов! Просим помочь нам! Они принимают только подарочные карты, поэтому тебе нужно отправить нам 100 карт Биса по 1000 евродолларов.
...
delivery-spam-12 = Присоединяйтесь к нам на первом рейсе!
    ...
    .content =
        ...
        За невероятно низкую цену в 5000 евродолларов за ночь, наш шестимесячный роскошный круиз может стать вашим для отпуска вашей мечты! Позвоните нам прямо сейчас по номеру [color=#00FF00]ОТДЫХ-ЩАС[/color] для бронирования. Чего же вы ждёте?! Звоните!
